...
const Footer = () => {
    ...
    return (
        <>
        <FirstDiv>
            <p>¡Dale vida a tu negocio con BEK!</p>
            <p>Ya sea un hotel, restaurante o terraza, en BEK tenemos los mejores muebles para exteriores a precios increíbles y stock </p>
            <form action="">
                {windowSize > 480 ? (
                <div>
                    <div>
